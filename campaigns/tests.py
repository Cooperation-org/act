...
class LinkedClaimTests(TestCase):
    ...
    def test_testimony_form_carries_recorder_and_video_url(self):
        r = self.client.get("/c/jreas-coop/testimony/")
        self.assertContains(r, 'id="video-recorder"')
...
class VouchTests(TestCase):
    ...
    def test_form_renders_walkup_friendly(self):
        ...
        self.assertContains(r, 'id="video-recorder"')      # recorder mount point
        self.assertContains(r, "video-recorder.js")         # self-hosted, tuned recorder
