"""Seed the JREAS Hub org + campaign (draft) from JREAS's own profile.

Content source: JREAS Hub's official EN profile deck (Sept 2026) and their LinkedIn.
...
Safe to re-run: get_or_create / guarded creates, never overwrites admin edits.
...
SUMMARY = (
    "A completely free workspace and study hub in Gaza with stable internet and continuous "
    "electricity. Launched December 2024; in under 16 months it has served 3,500+ beneficiaries "
    "across 390+ operating days and 3,000+ service hours — 100% free."
)
STORY = (
    "Over 100,000 students in Gaza could not sit a single online exam. Over 20,000 freelancers "
    "lost their international contracts overnight — not because they failed, but because the power "
    "went out and the network died.\n\n"
    "Jreas Hub was born from that need. In December 2024 a group of determined young Palestinians "
    "opened it in the heart of Gaza: a completely free workspace and study hub offering stable "
    "internet, continuous electricity, and a professional environment.\n\n"
    "It began with Wissal Jreas, a master's student who stood in the street holding her phone "
    "toward the sky as planes roared overhead, moving from street to street to find a signal — "
    "and reached her exam only to read: “Exam time has ended.” She asked why there was no "
    "single safe place with electricity, internet, and a roof where a person could learn. Jreas Hub "
    "started with two study seats — one for Wissal, one for her brother Moamen — and a decision to "
    ...
    "Every dollar does not simply buy a seat — it buys a lifelong opportunity for young people who "
    "refused to surrender."
)
ABOUT = (
    "JREAS Hub is a free coworking and study space in Gaza — stable internet, continuous "
    "electricity, a professional environment, and free training in digital skills — for students "
    "and freelancers cut off from the world by war. Running since December 2024; registered as "
    "JreasLab in October 2025."
)
# DRAFT — golda/JREAS to confirm the exact wording of the cooperative commitment.
GOVERNANCE = (
    "JREAS Hub is committed to becoming a cooperative, governed democratically by the students and "
    "freelancers who use it — the people it serves share in the decisions that shape it.\n\n"
...
CTAS = [
    ...
    ("networking", "Open your network",
     "Freelancers at the hub who lost clients need introductions, not sympathy. Connect them to "
     "people who hire.", "Make an intro"),
    ("hire", "Hire from the hub",
     "Developers, designers and translators working from the hub take remote contracts.", "I'm hiring"),
    ("event", "Host an event",
     "Pair with the team for a fundraiser night, a talk, or a livestream from the hub.", "Pair up"),
    ("ama", "Ask Me Anything",
     "A live session with the organizers: how the hub runs, what changes month to month.", "Get a reminder"),
...
TESTIMONIALS = [
    ("Lubna Al-Jarrah", "student",
     ...
     "weak internet connection. Joining Jreas Hub was a pivotal turning point: an environment that "
     "embraces ambition and gives a sense of focus and belonging. Thanks to this support I completed "
     "a practical course that required a computer I didn't have access to, and finished my projects "
     "successfully. This support turned challenges into achievements."),
    ("Najah Abu Za'nouna", "student",
     ...
     "to accept me. In the midst of that darkness, Jreas Hub gave me back my path. I graduated with a "
     "93.9% average — first in the commercial departments. Success is a decision."),
    ("Yahya Al-Halaw", "freelancer",
     "Joining Jreas Hub was a real golden opportunity. Within one year I obtained 16 professional "
     "certificates in mobile app development through edX — an achievement that would not have been "
     "possible without the supportive environment the initiative provided."),
]


class Command(BaseCommand):
    help = "Create the JREAS Hub org + campaign (draft) from JREAS's own profile content."
    ...
    def handle(self, *args, **opts):
        ...
        if created:
            c = Campaign.objects.create(
                org=org, slug=SLUG,
                title="JREAS Hub — a free workspace and study hub in Gaza",
